...
const API_URL = 'https://ink-muse.onrender.com';
...
axiosInstance.interceptors.response.use(
    ...
    async function(error) {  // make the callback async
        const processedError = await ProcessError(error);
        return Promise.reject(processedError); // reject with the actual object
    }
);
